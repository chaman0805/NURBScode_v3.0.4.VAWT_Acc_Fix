...
subroutine eval_faceshape_tet(nshl, bgp, igp, for, xl, dl, shlu, &
  ...
  real(8) :: bshlu(NSHLb), bshgradlu(NSHLb,2)
  real(8) :: bxdl(NSHLb,NSD)    
  real(8) :: dlxdxi(NSD,2)
  real(8) :: diff(NSD)
  ...
  ! Get basis functions and local ders
  call lintrishl(bgp, NSHLb, NSD, bshlu, bshgradlu)
...
!
!======================================================================  
subroutine eval_faceshape_hex(nshl, bgp, igp, for, xl, dl, shlu, shgradgu, &
                              dxidx, lnor)
  use aAdjKeep
  use commonvars
  use mpi
  ...
  ! Get basis functions and local ders
  call linquadshl(bgp, NSHLb, NSD, bshlu, bshgradlu)
...
end subroutine eval_faceshape_hex
